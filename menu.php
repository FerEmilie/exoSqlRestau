...
while ($donnees = $reponse->fetch())
{
  ...
  echo '<li>' . '<span>' . $donnees['nom'] . '</span>' . ' : ' . $donnees['concat_nom_plat'] . ' - ' . $donnees['prix_menu'] . ' euros. <div id="supp"><a href="deleteMenu.php?id=' . $donnees['idmenu'] . '"><< supprimer ce menu >></a></div></li>';
  echo '~~~';
  echo "</br></br>";
}
}
